 ...
 * @author Fernando
 */
@ManagedBean(name = "instalacionBean")
@ViewScoped
public class InstalacionBean implements Serializable {

    /**
     * Creates a new instance of InstalacionBean
     */
    @Getter
    @Setter
    ...
    @Getter
    @Setter
    private List<DetalleCatalogoReporte> listRepuestosHistorial;
    ...
    @Getter
    @Setter
    private DetalleCatalogoReporte repuestoHistorialSelected;
